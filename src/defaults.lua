return {
  ...
  chat = { enabled=true, height_percent=.21, target_height=240, min_height=160, max_height=320, visible_limit=1000, dedupe_seconds=3, timestamps=true, tab_order={"ALL","ROOM","PRIVATE","ESP","DRAGON","CONTACT","STAFF","COMBAT"}, all_sources={ROOM=true,WHISPER=true,ESP=true,DRAGON=true,SECIAN=true,CONTACT=true,STAFF=true,COMBAT=false} },
  colorization = {
    enabled=true,
    room_enabled=true,
    exits_enabled=true,
  ...
  github = { owner="wizzydizzy-ctrl", repository="dragons-gate-player-hud", channel="stable" },
