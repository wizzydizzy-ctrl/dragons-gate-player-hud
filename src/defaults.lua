return {
  ...
  colorization = {
    ...
    presence_color={136,190,153},
    presence_phrase_color={255,220,90},
  ...
  mapper = {
    ...
    special_timeout = 12,
    special_patterns = {},
    transition_submaps = {gate=false,portal=false,door=false,arch=false,path=false,other=false},
    zoom_step = 2.5,
    zoom_min = 3.0,
    zoom_max = 60.0,
  },
