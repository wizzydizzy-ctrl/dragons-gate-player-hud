    ...
    def test_build_emits_verified_owned_package(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with zipfile.ZipFile(recovery) as z:
                ...
                self.assertIn('<version>1.6.0</version>',recovery_xml)
                self.assertIn(f"local runtime={{version=&#x27;1.6.0&#x27;,owner=&#x27;{owner}&#x27;,repository=&#x27;{repository}&#x27;}}",recovery_xml)
            ...
            self.assertEqual(manifest['view_schema'],3)
